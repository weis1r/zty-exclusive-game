...
export const DEFAULT_LEVEL: LevelDefinition = {
  ...
  tiles: [
    ...
    { id: 'bloom-1', type: 'bloom', x: 134, y: 124, layer: 3 },
    { id: 'bloom-2', type: 'bloom', x: 210, y: 124, layer: 3 },
    { id: 'leaf-2', type: 'leaf', x: 134, y: 218, layer: 3 },
    { id: 'ember-2', type: 'ember', x: 210, y: 218, layer: 3 },

    { id: 'bell-1', type: 'bell', x: 106, y: 68, layer: 2 },
    { id: 'ember-3', type: 'ember', x: 182, y: 68, layer: 2 },
    { id: 'cloud-1', type: 'cloud', x: 258, y: 68, layer: 2 },
    { id: 'leaf-3', type: 'leaf', x: 106, y: 162, layer: 2 },
